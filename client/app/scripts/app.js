...
angular2_1.bootstrap(AppComponent, [router_1.ROUTER_PROVIDERS, angular2_1.bind(router_1.LocationStrategy).toClass(router_1.HashLocationStrategy), http_1.HTTP_PROVIDERS, area_service_1.AreaService]);
